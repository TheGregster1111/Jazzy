...
try:
    ...
    bot = commands.Bot(command_prefix=prefix, intents=discordIntents)

    bot.remove_command('help')

    spotify = spotipy.Spotify(client_credentials_manager=SpotifyClientCredentials(client_id='d1261d64a23947c3a69e6a0c0903c508', client_secret='18b358edd44a49c5a78b9d6c011e53c0'))
